        ...
        >
          {data.map((item, index) => (
            <div className="relative group inline-block w-[314px] bg-[#141414] border border-[#292929] rounded-[12px] m-1">
              ...
              <div
                key={index}
                className={`hidden group-hover:block w-[314px] absolute top-0 scale-[1] transition-all duration-300 ease-in-out ${contentToShow[index] && "  cursor-pointer p-2 transform  hover:scale-[1.2] overflow-hidden border border-[#292929] rounded-[12px] bg-[#141414] hover:z-[10] group"}`}
                ...
                contentToShow[index] && (
                  <div className="mt-2 p-[18px] opacity-0 group-hover:opacity-100 transition-all ease-in-out duration-300">
                    <div className="flex justify-between items-center">
                      <button onMouseEnter={() => setModalDisplay(true)} className="rounded-full w-[auto] h-[28px] bg-white overflow-hidden flex justify-center items-center text-[12px] text-black pr-[12px] pl-[4px]">
                        <svg className="" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-badge-info"><line x1="12" x2="12" y1="16" y2="12"/><line x1="12" x2="12.01" y1="8" y2="8"/></svg>
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    <p className="text-[14px] text-[#4ebe16] font-semibold">{item.title}</p>
