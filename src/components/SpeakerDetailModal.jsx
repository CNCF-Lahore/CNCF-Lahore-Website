    ...
    <div className='fixed top-0 left-0 w-full h-full flex justify-center items-center z-[100] bg-[rgba(0,0,0,0.6)]'>
        <div className="modal bg-[#141414]">
            ...
            <div className="header-content">
                ...
                <img src="https://i.imgur.com/O8SamCz.png" alt="Tears Of Steel" />
                ...
                <div className="header-buttons">
                    ...
                    <div type="iconButton" className="volume">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="modal-content-first">
                ...
                <h3 className='movie-watchers'>Watch in Hindi, Tamil, Telugu, Kannada, Malayalam, English</h3>
